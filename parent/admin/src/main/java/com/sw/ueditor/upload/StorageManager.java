...
public class StorageManager {
    ...
    public static State saveFileByInputStream(HttpServletRequest request, InputStream is, String path, String picName, long maxSize) {
        State state = null;
        ...
        try {
            ...
            //调用DFS的存储服务上传文件
            StorageManager.saveBinaryFile(dataBuf, path + "/" + picName);
            ...
            if (success) {
                ...
                state.putInfo("url", path);//文件访问的url填入此处
                tmpFile.delete();
            } else {

...
public final class ConfigManager {
     ...
     */
    private ConfigManager(String rootPath, String contextPath, String uri, FileUploadConfig fileUploadConfig) throws FileNotFoundException, IOException {
     ...
     */
    public static ConfigManager getInstance(String rootPath, String contextPath, String uri, FileUploadConfig fileUploadConfig) {

        try {
            return new ConfigManager(rootPath, contextPath, uri, fileUploadConfig);
        } catch (Exception e) {
            return null;
        }
    ...
    public Map<String, Object> getConfig(int type) throws JSONException {
        ...
        conf.put("savePathPrefix", fileUploadConfig.getSavePathPrefix());
    ...
    private void initEnv() throws FileNotFoundException, IOException {
        ...
        if (file.toString().contains(":\\")) {
            file = new File("admin/src/main/resources/config.json");
            if (!file.isAbsolute()) {
                file = new File(file.getAbsolutePath());
            }
        }
